...
export default function Navigation() {
  ...
  return (
    <nav className="space-y-2 px-2">
      <Link href="/dashboard" prefetch={true} className={getLinkClasses('/dashboard')}>
      ...
      <Link href="/dashboard/week" prefetch={true} className={getLinkClasses('/dashboard/week')}>
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
        </svg>
        Week View
      </Link>
      <Link href="/dashboard/month" prefetch={true} className={getLinkClasses('/dashboard/month')}>
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <Link href="/dashboard/settings" prefetch={true} className={getLinkClasses('/dashboard/settings')}>
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
