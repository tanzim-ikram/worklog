    ...
    <div className="space-y-6 pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm sm:text-base text-muted-foreground transition-all">Monthly overview & exports</p>
        </div>
      ...
      <div className="glass-panel p-4 sm:p-6 rounded-2xl">
        {loading ? (
          ...
          <div className="animate-fade-in-up">
            <div className="mb-6 flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6 sm:gap-2">
              <div>
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-2">
                ...
                <div className="flex items-center gap-2 flex-1 sm:flex-none">
                  <a
                    ...
                    download
                    className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-white/50 dark:bg-white/5 hover:bg-white dark:hover:bg-white/10 border border-gray-200 dark:border-white/10 rounded-xl text-xs sm:text-sm font-medium transition-all"
                  >
                  ...
                  <a
                    ...
                    download
                    className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 rounded-xl text-xs sm:text-sm font-medium transition-all"
                  >
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  return (
                    ...
                    >
                      <Link
                        ...
                        prefetch={true}
                        className="w-full h-full p-1 sm:p-2 flex flex-col justify-between"
                      >
                        <span className={`text-xs sm:text-sm ${isToday ? 'font-bold text-primary dark:text-primary' : 'text-foreground/70'}`}>
                          {format(day, 'd')}
                        </span>
